  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        residential: "url('../src/assets/Images/Segments/Residential.png')",
        institutional: "url('../src/assets/Images/Segments/Institutional.png')",
        commercial: "url('../src/assets/Images/Segments/Commercial.png')",
      },
    },
  },
  plugins: [],
